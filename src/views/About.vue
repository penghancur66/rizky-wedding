		...
		<div class="relative antialiased">
			<div class="w-full h-[90vh] lg:h-[97vh]">
				...
				<div class="absolute bottom-0">
					...
					<img class="w-screen object-cover -mb-1 lg:hidden flex" src="../assets/images/wave-resepsi-mobile.svg" alt="">
				</div>
			</div>
	...
	<section id="wave1" >
		<div class="relative">
			<div class="absolute top-0">
				<img class="w-screen object-cover -mt-4 hidden lg:flex" src="../assets/images/wave-blue.png" alt="">
				<img class="w-screen object-cover -mt-4 lg:hidden flex" src="../assets/images/wave-blue-mobile.png" alt="">
			</div>
			...
			<div class="absolute bottom-0">
				<img class="w-screen object-cover transform rotate-180 -mb-4 hidden lg:flex" src="../assets/images/wave-blue.png" alt="">
				<img class="w-screen object-cover transform rotate-180 -mb-4 flex lg:hidden" src="../assets/images/wave-blue-mobile.png" alt="">
			</div>
		</div>
	</section>
