...
<template>
	<div class="bg-white">
		...
		<div x-data="{ showModal : true }" >
			<!-- Modal Background -->
			<div x-show="showModal" class="fixed latar-modal bg-biruLight text-gray-500 flex items-center justify-center overflow-hidden z-50 left-0 right-0 top-0 bottom-0" x-transition:enter="transition ease duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease duration-300" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
				<!-- Modal -->
				<div class="relative h-[100vh]">
					<div class="flex flex-col items-center justify-center p-4">
						...
						<div class="py-4">
							<button class="bg-biruAccent/90 rounded-lg px-4 py-2 text-white shadow-md " x-on:click="showModal = false">
								Buka Undangan
							</button>
						</div>
					</div>
		...
		<!-- <img class="object-cover w-full lg:flex hidden" src="../assets/images/top.png" alt=""> -->
			<div class="w-full h-[90vh] lg:h-[97vh]">
				...
				<div class="absolute bottom-0">
					<img class="w-full object-cover -mb-1 hidden lg:flex" src="../assets/images/wave-resepsi-desktop.svg" alt="">
					<img class="w-full object-cover -mb-1 lg:hidden flex" src="../assets/images/wave-resepsi-mobile.svg" alt="">
				</div>
			</div>
		...
		<div class="latar">
			<div class="container mx-auto px-5 relative">
				...
				<div class="flex flex-col items-center py-6" data-aos="fade-up">
					<img class="w-36 text-black" src="../assets/images/path42.png" alt="">
					<p class="text-3xl font-aladin text-biruPrimary font-bold py-4 text-center">“Assalamualaikum Warahmatullahi Wabarakatuh”</p>
					<p class="text-center leading-normal">Tanpa mengurangi rasa hormat, Kami bermaksud mengundang Bapak/Ibu/Saudara/i untuk menghadiri acara pernikahan putra putri kami :</p>
				</div>
				<div class="flex flex-col lg:flex-row lg:justify-around items-center">
					<div class="flex flex-col items-center">
						<div class="p-2 bg-gradient-to-br from-biruAccentLight rounded-full" data-aos="fade-right">
							<img class="rounded-full" src="../assets/images/girl.png" alt="">
						</div>
						<div class="text-center mt-4" data-aos="zoom-in">
							<p class="text-3xl mb-4 font-aladin text-biruPrimary">Syarah reysita yusuf </p>
							<p class="font-semibold text-neutral-400">Putri dari :</p>
							<p class="font-bold text-neutral-400">Bapak Achmad Yusuf & Ibu Ita Masyitah</p>
						</div>
					</div>
					<div class="py-8 lg:py-0" data-aos="fade-down">
						<img class="w-12 h-12" src="../assets/images/And.png" alt="">
					</div>
					<div class="flex flex-col items-center">
						<div class="p-2 bg-gradient-to-br from-biruAccentLight rounded-full" data-aos="fade-left">
							<img class="rounded-full" src="../assets/images/boy.png" alt="">
						</div>
						<div class="text-center mt-4" data-aos="zoom-in">
							<p class="text-3xl mb-4 font-aladin text-biruPrimary">Briptu Ifan Aditiya Eka Widiatama </p>
							<p class="font-semibold text-neutral-400">Putri dari :</p>
							<p class="font-bold text-neutral-400">Bapak Sarmadi & Ibu Lilik Sumarni </p>
						</div>
					</div>
				</div>
				</div>
	...
	<section id="wave1" >
		<div class="relative">
			<div class="absolute top-0">
				<img class="w-full object-cover -mt-4 hidden lg:flex" src="../assets/images/wave-blue.png" alt="">
				<img class="w-full object-cover -mt-4 lg:hidden flex" src="../assets/images/wave-blue-mobile.png" alt="">
			</div>
			...
			<div class="absolute bottom-0">
				<img class="w-full object-cover transform rotate-180 -mb-4 hidden lg:flex" src="../assets/images/wave-blue.png" alt="">
				<img class="w-full object-cover transform rotate-180 -mb-4 flex lg:hidden" src="../assets/images/wave-blue-mobile.png" alt="">
			</div>
		</div>
	</section>
					...
					<div class="flex flex-col items-center ">
						...
						<div class="lg:w-2/3 bg-white border rounded-lg border-biruAccentLight pt-3 pb-2 px-2" data-aos="flip-left">
							...
							<div class="flex justify-center py-4">
								<a class="bg-biruAccent text-white rounded-md px-4 py-2" href="#">Lihat Lokasi di Peta</a>
							</div>
						</div>
					</div>
					
					<div class="text-center my-16" data-aos="zoom-in-up">
						<p class="text-biruPrimary text-5xl font-rancho mb-2">Protokol Covid-19</p>
						<p class="text-xs text-neutral-400">Tanpa mengurangi rasa hormat, dikarenakan situasi yang sedang terjadi ditengah Pandemi Covid-19 ini kami memohon maaf karena acara akan diselenggarakan sesuai peraturan dan himbauan pemerintah.</p>
					</div>
			...
			<div class="absolute z-10 transform top-[5%] lg:top-[10%] w-full text-center">
				...
				<div class="flex lg:justify-around flex-col lg:flex-row items-center mb-8">
					<div class="flex flex-col items-center" data-aos="flip-right" data-aos-delay="500">
						<p class="text-white font-mclaren text-8xl mb-2">12</p>
						<p class="text-white uppercase">FOR THE WEDDING</p>
					</div>
					<div class="flex flex-col items-center" data-aos="flip-right" data-aos-delay="1000">
						<p class="text-white font-mclaren text-8xl mb-2">02</p>
						<p class="text-white uppercase">SYARAH & IFAN</p>
					</div>
					<div class="flex flex-col items-center" data-aos="flip-right" data-aos-delay="1500">
						<p class="text-white font-mclaren text-8xl mb-2">22</p>
						<p class="text-white uppercase">KUTA, BALI</p>
					</div>
				</div>
				<div class="flex justify-center" data-aos="fade-up" data-aos-delay="1500">
					<div class="flex justify-between space-x-5 lg:space-x-0 lg:w-1/3 px-10 lg:px-0">
						<div class="flex flex-col items-center">
							<div class="p-2 rounded-full border border-white">
								<p class="text-white text-2xl">02</p>
							</div>
							<p class="text-white text-xs mt-2">Hari</p>
						</div>
						<div class="flex flex-col items-center">
							<div class="p-2 rounded-full border border-white">
								<p class="text-white text-2xl">02</p>
							</div>
							<p class="text-white text-xs mt-2">Jam</p>
						</div>
						<div class="flex flex-col items-center">
							<div class="p-2 rounded-full border border-white">
								<p class="text-white text-2xl">02</p>
							</div>
							<p class="text-white text-xs mt-2">Menit</p>
						</div>
						<div class="flex flex-col items-center">
							<div class="p-2 rounded-full border border-white">
								<p class="text-white text-2xl">02</p>
							</div>
							<p class="text-white text-xs mt-2">Detik</p>
						</div>
					</div>
				</div>
				<div class="text-center mt-5" data-aos="fade-up" >
					<a href="#" class="bg-biruAccent text-xs px-5 font-poppins transform py-2 rounded-md text-white hover:bg-biruAccent/75 hover:scale-125">Save Date to Calendar</a>
				</div>
			</div>
			<div class="absolute bottom-0">
				<img class="w-full object-cover transform rotate-180 -mb-4 hidden lg:flex" src="../assets/images/wave-blue.png" alt="">
		...
		<div class="container mx-auto px-5">
			<div class="py-10 lg:px-10">
					<div class="text-center mb-8" data-aos="zoom-in-up">
						<p class="text-biruPrimary text-3xl font-rancho tracking-wide mb-2">Galeri Foto</p>
						...
						<div class="flex lg:justify-between flex-col lg:flex-row  lg:gap-x-8">
							<div class="lg:w-1/2 w-full mb-4">
								<div class="mb-4 flex flex-col">
									...
									<textarea class="form-text-area bg-white border rounded transition ease-in-out w-full shadow-lg border-gray-400 focus:text-gray-700 focus:border-biruPrimary focus:outline-none" name="ucapan" id="" cols="10" rows="5" placeholder="Tulis ucapan anda disini"></textarea>
								</div>
								<a href="#" class="w-full inline-block text-center bg-biruAccent text-white py-1 rounded hover:bg-biruAccent/90">Kirim ucapan</a>
							...
							<div class="lg:w-1/2 w-full">
								<div class="lg:mb-6 mb-4 flex flex-col">
									<label for="nama" class="text-base text-formulir">Nama</label>
									<input placeholder="Tulis nama anda disini" type="text" class="form-input bg-white border rounded transition ease-in-out w-full shadow-lg border-gray-400 focus:text-gray-700 focus:border-biruPrimary focus:outline-none">
								</div>
								<div class="mb-4 flex flex-col">
									<label for="nama" class="text-base text-formulir">Alamat</label>
									<input placeholder="Tulis alamat anda disini" type="text" class="form-input bg-white border rounded transition ease-in-out w-full shadow-lg border-gray-400 focus:text-gray-700 focus:border-biruPrimary focus:outline-none">
								</div>
								<div class="flex items-center mb-4">
									<div class="mr-5">
										<input id="hadir" class="form-radio text-biruPrimary mr-2 outline-none focus:outline-none" name="kehadiran" value="hadir" type="radio">
										<label for="hadir" class="text-neutral-500">Hadir</label>
									</div>
									<div>
										<input id="tidak_hadir" class="form-radio text-biruPrimary mr-2 outline-none focus:outline-none" name="kehadiran" value="tidak_hadir" type="radio">
										<label for="tidak_hadir" class="text-neutral-500">Tidak Hadir</label>
									</div>

								</div>
								<a href="#" class="w-full inline-block text-center bg-biruAccent text-white py-1 rounded hover:bg-biruAccent/90">Konfirmasi Kehadiran</a>
							</div>
						</div>
					</div>
			</div>
